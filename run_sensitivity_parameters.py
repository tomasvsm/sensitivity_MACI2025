...
if __name__ == '__main__':
    ...
    output_dir = "sensitivity_parameters"
    ...
    multiplicative_factors = [
        ...
        'ovr1_factor', 'ovr2_factor', 'a0_factor', 'valpha_factor'
    ]
    
    # Parámetros fijos
    fixed_parameters = {'egn': 63.0, 'me': 0.01, 'ef': 0.83, 'ma': 0.09, 'mdlr': 2.0}
    ...
    # Itera sobre factores multiplicativos y sus variaciones
    for factor in multiplicative_factors:
        for variation in variations:
            factor_value = 1 + variation
            update = {
                'model_parameters': {
                    factor: factor_value
                }
            ...
            # Define el nombre de salida basado en el factor y la variación
            output_filename = f"{factor}_var{int(variation * 100)}.csv"
            output_path = os.path.join(output_dir, output_filename)

            # Ejecuta el modelo y guarda los resultados
            print(f"Running model for {factor} with variation {variation * 100}%...")
